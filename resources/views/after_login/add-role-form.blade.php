                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-8">
                                <div class="box box-info">
                                    ...
                                    <!-- /.box-header -->
                                    <!-- form start -->
                                    <form class="form-horizontal" action="/save-role-details" method="get">
                                        @csrf
                                        <div class="box-body">
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-2 col-form-labe">Role</label>
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control col-sm-13" id="inputEmail3" name="role" placeholder="Enter the role" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-2"></div>
                                            <div class="col-sm-4">
                                                <button type="submit" class="btn btn-warning ajax"><a href="/roles" style="color:white;">Back</a></button>
