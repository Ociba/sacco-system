  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal mt-3" method="post" action="/save-coming-soon" enctype="multipart/form-data">
              @csrf
                <div class="card-body">
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Expected Date</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" name="expected_date" placeholder="YY/MM/DD" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Message</label>
                    <div class="col-sm-10">
                      <textarea type="text" class="form-control" id="inputEmail3" name="message" rows="7" placeholder="write role details" required></textarea>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
