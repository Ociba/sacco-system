            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped auto">
                  <tbody>
                  @foreach($display_mails_received_inbox as $inbox)
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    <td class="mailbox-name"><a href="/display-readmail/{{$inbox->id}}">{{$inbox->name}}</a></td>
                    <td class="mailbox-subject"><b>{{substr($inbox->subject,0,30)}}</b> 
                    </td>
                    <td>-{{substr($inbox->message,0,15)}}....</td>
                    <td class="mailbox-attachment">{{$inbox->attachment}}</td>
                    <td class="mailbox-date">{{ date('F d, Y', strtotime($inbox->created_at))}} {{ date('g:ia', strtotime($inbox->created_at))}}</td>
                  </tr>
                  @endforeach
                  </tbody>
                </table>
