            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages ">
                <table class="table table-hover table-striped auto">
                  <tbody>
                  @foreach($display_replied_mails as $reply)
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    <td class="mailbox-name"><a href="/display-readmail/{{$reply->id}}">{{$reply->name}}</a></td>
                    <td class="mailbox-subject"><b>{{substr($reply->subject,0,30)}}</b> 
                    </td>
                    <td>-{{substr($reply->message,0,15)}}....</td>
                    <td class="mailbox-attachment">{{$reply->attachment}}</td>
                    <td class="mailbox-date">{{ date('F d, Y', strtotime($reply->created_at))}} {{ date('g:ia', strtotime($reply->created_at))}}</td>
                  </tr>
                  @endforeach
                  </tbody>
                </table>
