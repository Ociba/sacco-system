            ...
            <div class="box-body">
              ...
              <li class="list-group-item"><a href="/display-mailbox" class="btn-default"><i class="fa fa-inbox"></i> Inbox
                ...
                <li class="list-group-item"><a href="/display-trash" class="btn-default"><i class="fa fa-trash-o"></i> Trash
                 <span class="pull-right text-red">{{auth()->user()->countTrashMails()}}</span></a></li>
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                  @foreach($display_mails_deleted_intrash as $trash)
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    <td class="mailbox-name"><a href="/display-readmail/{{$trash->id}}">{{$trash->name}}</a></td>
                    <td class="mailbox-subject"><b>{{substr($trash->subject,0,30)}}</b>
                    </td>
                    <td >-{{substr($trash->message,0,15)}}....</td>
                    <td class="mailbox-attachment">{{$trash->attachment}}</td>
                    <td class="mailbox-date">{{ date('F d, Y', strtotime($trash->created_at))}} {{ date('g:ia', strtotime($trash->created_at))}}</td>
                  </tr>
                @endforeach
                  </tbody>
                </table>
